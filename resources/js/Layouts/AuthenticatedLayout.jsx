...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-100 dark:bg-gray-900">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/"><ApplicationLogo className="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" /></Link>
                            </div>
            ...
            {header && <header className="bg-white dark:bg-zinc-800 shadow-sm flex-shrink-0"><div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">{header}</div></header>}
