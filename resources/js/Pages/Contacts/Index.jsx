...
const UserCard = ({ user, children }) => (
    <div className="p-4 bg-gray-100 dark:bg-zinc-900 rounded-lg flex justify-between items-center">
        <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 flex items-center justify-center font-bold">
                {user.name.charAt(0)}
            </div>
            <div>
...
const AddButton = ({ user }) => (
    <Link
        ...
        className="inline-flex items-center justify-center p-2 bg-primary-600 hover:bg-primary-700 text-white rounded-full"
...
const AcceptButton = ({ user }) => (
    <Link
        ...
        className="inline-flex items-center justify-center p-2 bg-green-600 hover:bg-green-700 text-white rounded-full"
...
const RemoveButton = ({ user, title }) => (
    <Link
        ...
        className="inline-flex items-center justify-center p-2 bg-red-600 hover:bg-red-700 text-white rounded-full"
        title={title}
    >
                        ...
                        <div className="space-y-4">
                            <div className="p-4 sm:p-6 bg-white dark:bg-zinc-800 shadow sm:rounded-lg">
                                ...
                                <form onSubmit={searchUsers} className="flex gap-2">
                                    ...
                                    {/* --- THIS IS THE FIX ---
                                        Changed 'processing={processing}' to 'disabled={processing}'
                                    */}
                        ...
                        <div className="p-4 sm:p-6 bg-white dark:bg-zinc-800 shadow sm:rounded-lg">
                            ...
                            <div className="space-y-3">
                                {myContacts.length > 0 ? (
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400">Search for people to add to your contacts.</p>
                                )}
                            </div>
                        </div>
                            ...
                            <div className="p-4 sm:p-6 bg-white dark:bg-zinc-800 shadow sm:rounded-lg">
                                ...
                                <div className="space-y-3">
                                    {pendingReceived.length > 0 ? (
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">No new contact requests.</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="p-4 sm:p-6 bg-white dark:bg-zinc-800 shadow sm:rounded-lg">
                                ...
                                <div className="space-y-3">
                                    {pendingSent.length > 0 ? (
                                        ...
                                        <p className="text-gray-500 dark:text-gray-400">No pending sent requests.</p>
                                    )}
                                </div>
                            </div>
                        </div>
